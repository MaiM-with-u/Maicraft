...
**view_chest**
查看箱子的内容物，必须先view_chest，才能使用use_chest
{{
    "action_type":"view_chest",
    "x":"箱子位置，可选",
    "y":"箱子位置，可选",
    "z":"箱子位置，可选",
}}
...
2.如果使用完毕，请使用finish_using动作
3.先总结之前的思考和执行的记录，输出一段想法
4.想法要求简短，精准，如果要描述坐标，完整的描述，不要有多余信息
5.然后根据现有的**动作**，**任务**,**情景**，**物品栏**和**周围环境**，选择合适的动作，推进任务进度
规划内容是一段平文本，不要分点
