...
@containers_router.get("", response_model=ApiResponse)
...
@containers_router.get("/verify/{x}/{y}/{z}", response_model=ApiResponse)
...
@containers_router.delete("/invalid", response_model=ApiResponse)
...
@containers_router.get("/stats", response_model=ApiResponse)
