...
@game_rest_router.get("/snapshot", response_model=UnifiedApiResponse)
...
@game_rest_router.get("/player", response_model=UnifiedApiResponse)
...
@game_rest_router.get("/inventory", response_model=UnifiedApiResponse)
...
@game_rest_router.get("/world", response_model=UnifiedApiResponse)
...
@game_rest_router.get("/nearby/entities", response_model=UnifiedApiResponse)
