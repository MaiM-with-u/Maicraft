...
@locations_router.get("", response_model=ApiResponse)
...
@locations_router.get("/stats", response_model=ApiResponse)
...
@locations_router.post("", response_model=ApiResponse)
...
@locations_router.get("/{name}", response_model=ApiResponse)
...
@locations_router.put("/{name}", response_model=ApiResponse)
...
@locations_router.delete("/{name}", response_model=ApiResponse)
